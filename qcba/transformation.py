...
class QCBATransformation:
    ...
    def transform(self, rules, transformation_dict={}):
        ...
        if not transformation_dict:
            ...
            overlap_pruned = self.overlap_pruner.transform(
                post_pruned, default_class, transaction_based=self.transaction_based_drop)
            ...
            if transformation_dict.get("literal_pruning", False):
                ...
                transformed_rules = self.literal_pruner.transform(
                    transformed_rules)
            ...
            print("post pruning")
            transformed_rules, default_class = self.post_pruner.transform(
                transformed_rules)
            ...
            if transformation_dict.get("overlap_pruning", False):
                ...
                transformed_rules = self.overlap_pruner.transform(
                    transformed_rules, default_class, transaction_based=transaction_based)
